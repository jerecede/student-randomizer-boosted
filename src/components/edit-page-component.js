    ...
    render() {
        ...
        const html =`
            <form id="form-edit" class="form-edit">
                ...
                <input type="text" name="name" id="name" maxlength="25" value='${student.name}' required>

                <label for="surname">surname</label>
                <input type="text" name="surname" id="surname" maxlength="25" value='${student.surname}' required>
